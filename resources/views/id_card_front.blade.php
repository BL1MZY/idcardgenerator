...
<body>
    <div class="id-card mb-4 w-full h-auto md:w-[450px] md:h-[286px] " style="background-image: url({{ Auth::user()->status == 'Approved' ? asset('photo/lincoln.png') : asset('photo/notapproved.png')  }});padding:0;height:340px;width:640px">
    ...
    <div class="id-card w-full md:w-[450px] md:h-[286px]" style="background-image: url({{ Auth::user()->status == 'Approved' ? asset('photo/lincoln.png') : asset('photo/notapproved.png') }}); padding: 0; height: 340px; width: 640px; margin-top:3rem">
